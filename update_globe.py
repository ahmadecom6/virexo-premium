...
with open('src/components/canvas/TechGlobe.jsx', 'r', encoding='utf-8') as f:
    code = f.read()

replacement = """import React, { useRef, useEffect } from 'react'
...
with open('src/components/canvas/TechGlobe.jsx', 'w', encoding='utf-8') as f:
    f.write(replacement)

print("TechGlobe updated")
